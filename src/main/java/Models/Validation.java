    ...
    public static String checkInputName() {
        while (true) {
            ...
            if (result.isEmpty()) {
                ...
                System.err.println("Alphabet only");
    ...
    public static String checkInputPhone() {
        while (true) {
            ...
            if (result.isEmpty()) {
                ...
                System.err.println("Number only(10 digits)");
    ...
    public static String checkInputID() {
        while (true) {
            ...
            if (result.isEmpty()) {
                ...
                System.err.println("Number only(12 digits, start with 0)");
    ...
    public static String checkInputPassword() {
        while (true) {
            ...
            if (result.isEmpty()) {
                ...
                System.err.println("Alphabet and number only");
                System.out.print("Enter again: ");
            }
        }
    }
